            ...
            return Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text('₹${_fmtAmt(cat.total)}', style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w700, fontSize: 15, color: appColors.expense)),
                ],
              ),
            );
          }).toList(),
...
// Helper to convert category color hex to Flutter Color
