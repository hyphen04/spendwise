...
class ImportPreviewSheet extends StatelessWidget {
  ...
  static Future<bool?> show(BuildContext context, ImportPreview preview) {
    return showSpendWiseSheet<bool>(
      context,
      showChrome: false,
                  ...
                  Row(
                    children: [
                      ...
                      _Pill(
                        ...
                        sublabel: 'skipped',
                        color:
                            hasErrors ? cs.errorContainer : cs.surfaceContainer,
                        textColor: hasErrors
                            ? cs.onErrorContainer
                            : cs.onSurfaceVariant,
                      ),
                      ...
                      _Pill(
                        ...
                        color:
                            hasNew ? cs.tertiaryContainer : cs.surfaceContainer,
                        textColor: hasNew
              ...
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: names.join(', '),
                    style:
                        tt.labelSmall?.copyWith(color: cs.onTertiaryContainer),
                  ),
                ],
              ),
            ),
